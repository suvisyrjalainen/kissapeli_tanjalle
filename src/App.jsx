...
export default function App(){
    ...
    const [pelattu, vaihdaTila] = useState(false)
    ...
    function compareCards() {
        ...
        const pelaajanStatus = kortit.pelaaja[0].ominaisuudet[valittuOminaisuus];
        const vastustajanStatus = kortit.vastustaja[0].ominaisuudet[valittuOminaisuus];
                ...
                <div className='hand'>
                    ...
                    {kortit.vastustaja.map((vastustajanKortti, index)=> (
                        <li className='korttirivin-kortti vastustaja' key={vastustajanKortti.id}>
                            <Card card={index === 0 ? vastustajanKortti : null} tila={pelattu}/>
                        </li>
                    ))}
                    </ul>
                </div>
